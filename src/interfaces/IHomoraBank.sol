...
//   }
    ...
    function borrowBalanceStored(uint256, address) external returns (uint256);
    ...
    function getBankInfo(address) external returns (bool, address, uint256, uint256, uint256);
    function getBorrowETHValue(uint256) external returns (uint256);
    function getCollateralETHValue(uint256) external returns (uint256);
    function getCurrentPositionInfo() external returns (address, address, uint256, uint256);
    function getPositionDebtShareOf(uint256, address) external returns (uint256);
    function getPositionDebts(uint256) external returns (address[] memory, uint256[] memory);
    function getPositionInfo(uint256) external returns (address, address, uint256, uint256);
    ...
    function support(address) external returns (bool);
